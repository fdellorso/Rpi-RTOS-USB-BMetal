...
//
#ifndef _rsta_bt_bluetooth_h
#define _rsta_bt_bluetooth_h
...
typedef struct TBTHCICommandHeader
{
	u16	OpCode;
...
PACKED TBTHCIInquiryCommand;

typedef struct TBTHCIRemoteNameRequestCommand
{
	TBTHCICommandHeader	Header;
...
PACKED TBTHCIRemoteNameRequestCommand;

typedef struct TBTHCIWriteLocalNameCommand
{
	TBTHCICommandHeader	Header;

	u8	LocalName[BT_NAME_SIZE];
}
PACKED TBTHCIWriteLocalNameCommand;

typedef struct TBTHCIWriteScanEnableCommand
{
	TBTHCICommandHeader	Header;
...
PACKED TBTHCIWriteScanEnableCommand;

typedef struct TBTHCIWriteClassOfDeviceCommand
{
	TBTHCICommandHeader	Header;

	u8	ClassOfDevice[BT_CLASS_SIZE];
}
PACKED TBTHCIWriteClassOfDeviceCommand;

// Events

typedef struct TBTHCIEventHeader
{
	u8	EventCode;
...
PACKED TBTHCIEventHeader;

typedef struct TBTHCIEventInquiryComplete
{
	TBTHCIEventHeader	Header;

	u8	Status;
}
PACKED TBTHCIEventInquiryComplete;

typedef struct TBTHCIEventInquiryResult
{
	TBTHCIEventHeader	Header;
...
PACKED TBTHCIEventInquiryResult;

typedef struct TBTHCIEventRemoteNameRequestComplete
{
	TBTHCIEventHeader	Header;
...
PACKED TBTHCIEventRemoteNameRequestComplete;

typedef struct TBTHCIEventCommandComplete
{
	TBTHCIEventHeader	Header;
	...
	u8	*ReturnParameter;		// FIXME Warning
}
PACKED TBTHCIEventCommandComplete;

typedef struct TBTHCIEventReadBDAddrComplete
{
	TBTHCIEventCommandComplete	Header;

	u8	BDAddr[BT_BD_ADDR_SIZE];
}
PACKED TBTHCIEventReadBDAddrComplete;

typedef struct TBTHCIEventCommandStatus
{
	TBTHCIEventHeader	Header;
...
PACKED TBTHCIEventCommandStatus;
